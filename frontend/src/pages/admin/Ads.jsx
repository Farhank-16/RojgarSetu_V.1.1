...
const PLACEMENTS = [
  { value: 'top_banner',      label: 'Top Banner',      desc: 'Fixed bar at the very top of screen' },
  { value: 'middle_section',  label: 'Middle Section',  desc: 'Card between content (job listings, dashboard)' },
  { value: 'bottom_banner',   label: 'Bottom Banner',   desc: 'Sticky bar just above bottom nav' },
];

const EMPTY_FORM = {
  title: '', redirect_url: '', placement: 'bottom_banner',
  media_type: 'image', auto_play: false,
